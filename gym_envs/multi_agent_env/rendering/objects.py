...
from gym_envs.multi_agent_env.rendering import RenderSpec
...
class Car:
    ...
    def __init__(
        ...
        self.base_color = color or (0, 0, 0)
    ...
    def update(self, state: dict[str, np.ndarray], idx: int):
        ...
        self.color = (255, 0, 0) if state["collisions"][idx] > 0 else self.base_color
